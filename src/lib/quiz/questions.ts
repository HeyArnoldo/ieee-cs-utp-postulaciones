...
export const QUESTIONS: readonly QuestionConfig[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { v: 'administracion', label: 'Administración de Empresas', emoji: '💼' },
  ...
  },
  {
    ...
    kind: 'choice',
    qn: '04 · Investigación',
    title: '¿Cuántos papers has publicado?',
    hint: 'Buscamos docentes que asesoren investigación — cuéntanos tu experiencia publicando.',
    options: [
      { v: '0', label: '0 publicados', emoji: '📄' },
      { v: '1', label: '1 publicado', emoji: '📄' },
      { v: '2', label: '2 publicados', emoji: '📑' },
      { v: '3', label: '3 publicados', emoji: '📚' },
      { v: '4', label: '4 publicados', emoji: '📚' },
      { v: '5+', label: '5 o más', emoji: '🏆' },
      { v: 'pendiente', label: 'Tengo uno culminado, falta publicarlo', emoji: '⏳' },
    ] as ChoiceOption[],
    aiLine: 'Sara IA considera tu experiencia investigadora al evaluar tu perfil docente.',
    showIf: (answers) => answers.applicantType === 'docente',
    validate: (answers) => {
      const v = answers.papers;
      return typeof v === 'string' && v.length > 0;
    },
  },
  {
    ...
    kind: 'choice',
    qn: '05 · Tu área',
    title: '¿En qué área te gustaría aportar o crecer?',
    hint: 'Elige la que más te llama hoy — el capítulo es multidisciplinario.',
    options: [
      ...
      { v: 'design', label: 'UX / UI / Diseño de producto', emoji: '🎨' },
      { v: 'marketing', label: 'Marketing / Contenido / Redes', emoji: '📣' },
      { v: 'ops', label: 'Organización y planificación', emoji: '🗂️' },
      { v: 'people', label: 'Gestión de personas / Cultura', emoji: '🤝' },
